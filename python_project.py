import re,psutil,cv2,webbrowser,requests,pygame,json,math,wikipedia
...
def fn_list():     
     ...
     print("2.today's weather condition")
     print("3.wikipedia about any person")
     print("4.play video")
     print("5.performed calculator operation")
     print("6.send mobile message to your friend \n (only registered mobile no.9664******4)")
     print("7.find  meaning of word")
     print("8.click your picture")
     print("9.open browser")
